                        ...
                        <Col>
                            ...
                            <Row className='mt-4'>
                                ...
                                <Col className='text-center'>
                                    ...
                                    <p className='mb-0'>
                                        Email: <a className="text-decoration-none text-black" href="mailto:sandip.basak@thezurihotels.com">simran.randhawa@thezurihotels.com</a>
                                    </p>
                                    <p>
                                        Tel:<a className="text-decoration-none text-black" href='tel:8484906209' >+91 848 490 6209 </a>
                                    </p>
                                </Col>
                            </Row>
                        </Col>
