...
const EventsBannerKumarkom = () => {
    const BannerImg = {
        backgroundImage: `url('/kumarkom/events/kumarakom_banner.jpg')`,
        height: 600,
    ...
    return (
        <Container className='p-0' style={{}}>
            ...
            <Col className='d-flex flex-row flex-wrap p-0 align-items-center pt-1 ps-lg-0 ps-1'>
                ...
                <Link href=""
                    className='text-decoration-none mb-0'>
                    <h6 className='text-custom-megenta font12px mb-0'>Restaurants, Kerala</h6>
                </Link> */}
            </Col>
...
export default EventsBannerKumarkom