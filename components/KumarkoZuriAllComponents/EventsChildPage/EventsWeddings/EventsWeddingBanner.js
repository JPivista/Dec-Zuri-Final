...
const EventsWeddingBanner = () => {
    const BannerImg = {
        backgroundImage: `url('/kumarkom/events/kumarakom_wedding_banner.jpg')`,
        height: 600,
    ...
    return (
        <Container className='p-0' style={{}}>
            ...
            <Col className='d-flex flex-row flex-wrap p-0 align-items-center' >
                ...
                /
                <Link href="/lake-resorts-in-kumarakom/events/weddings/"
                    className='text-decoration-none mb-0'>
                    <h6 className='text-custom-megenta font12px mb-0'>Wedding</h6>
                </Link>
            </Col>
        </Container >
    )
...
export default EventsWeddingBanner