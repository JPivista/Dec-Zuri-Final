        ...
        <>
            <Container className='p-0 pt-4 text-center px-md-5 pb-5' style={{}}>
                <Col className=''>
                    ...
                    <h6 className='py-4 pt-4 text-center'>TREATMENTS & THERAPIES</h6>
                    ...
                    >
                        ...
                        <Col className='text-center d-flex flex-column align-items-center gap-4 pe-lg-5 me-lg-5'>
                            <Image src='/kumarkom/maya-spa/ayurveda_package_thumb.jpg' alt='' roundedCircle width={180} height={180}
                                className='rounded-circle kumarkom-image-overlay'
                            />
