...
const AyurvedaMayaSpaKumakomBanner = () => {
    const BannerImg = {
        backgroundImage: `url('/kumarkom/maya-spa/maya_spa_banner.jpg')`,
        height: 466,
        ...
        <Container className='p-0' style={{}}>
            ...
            <Col className='d-flex flex-row flex-wrap p-0 align-items-center' >
                ...
                <Link href="/lake-resorts-in-kumarakom/maya-spa/"
                    className='text-decoration-none mb-0'>
                    <h6 className='text-custom-megenta font12px mb-0'> Maya Spa, Kerala</h6>
                </Link>
            </Col>
...
export default AyurvedaMayaSpaKumakomBanner