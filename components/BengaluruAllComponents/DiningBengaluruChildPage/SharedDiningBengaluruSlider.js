...
const SharedDiningBengaluruSlider = () => {
    const responsive = {
        desktop: {
                ...
                <Col className='d-flex flex-column d-md-none'>
                    ...
                    >
                        <Col className='text-center d-flex flex-column align-items-center gap-4 ps-lg-5 ms-lg-5' >
                            <Image src='/bengaluru/dining/karibu_thumb_1.jpg' alt='' roundedCircle width={180} height={180}
                                className='rounded-circle kumarkom-image-overlay'
                            />

                            <Link
                                href="/hotels-in-bengaluru/restaurants/karibu/"
                                style={buttonHover}
                        ...
                        <Col className='text-center d-flex flex-column align-items-center gap-4' >
                            <Image src='/bengaluru/dining/incanto_thumb_2.jpg' alt='' roundedCircle width={180} height={180}
                                className='rounded-circle kumarkom-image-overlay'
                            />
                            <Link
                                href="/hotels-in-bengaluru/restaurants/incanto/"
                                style={buttonHover1}
                        ...
                        <Col className='text-center d-flex flex-column align-items-center gap-4 pe-lg-5 me-lg-5'>
                            <Image src='/bengaluru/dining/sake_thumb_3.png' alt='' roundedCircle width={180} height={180}
                                className='rounded-circle kumarkom-image-overlay'
                            />

                            <Link
                                href="/hotels-in-bengaluru/restaurants/sake/"
                                style={buttonHover2}
                        ...
                        <Col className='text-center pt-md-5 d-flex flex-column align-items-center gap-4  ps-md-5 ms-md-5'>
                            <Image src='/bengaluru/dining/bling_thumb_4.jpg' alt='' roundedCircle width={180} height={180}
                                className='rounded-circle kumarkom-image-overlay'
                            />

                            <Link
                                href="/hotels-in-bengaluru/restaurants/bling/"
                                style={buttonHover3}
                        ...
                        <Col className='text-center pt-md-5 d-flex flex-column align-items-center gap-4 me-md-5 pe-md-5'>
                            <Image src='/bengaluru/dining/infinity_thumb_5.jpg' alt='' roundedCircle width={180} height={180}
                                className='rounded-circle kumarkom-image-overlay'
                            />

                            <Link
                                href="/hotels-in-bengaluru/restaurants/infinity/"
                                style={buttonHover3}
                                onMouseEnter={handleMouseEnter3}
                                onMouseLeave={handleMouseLeave3}
                                className='px-5 py-2 mb-5 mb-md-0 text-decoration-none'
...
export default SharedDiningBengaluruSlider