...
const MayaSpaBangaluruContent = () => {
    ...
    return (
        <>
            <Container className='p-md-0 p-2 px-lg-5'>
                ...
                <Col className='text-center pt-4'>
                    <Image src='/cl.png' alt='' fluid />
                    <h6 className='py-2 text-center'>SPA TREATMENT</h6>
                </Col>
            ...
            <Container className='p-md-0 px-md-5 p-2'>
                <Col className='d-flex flex-column align-items-center text-center py-5'>
                    <Image src='/cl.png' alt='' fluid />
                    <h6 className='py-2 text-center'>KICK-START</h6>
                    <p>
