...
const AboutBengaluruHeader = () => {
    return (
        <>
            <Container className='custom-kumarkom-menu-container'>

                <h3 className='text-center pt-md-2 text-custom-grey'>THE ZURI WHITEFIELD, BENGALURU</h3>
                ...
                <Col className='d-md-none d-block pb-2'>
...
export default AboutBengaluruHeader