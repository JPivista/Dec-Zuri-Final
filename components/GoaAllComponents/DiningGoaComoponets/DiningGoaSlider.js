...
const DiningGoaSlider = () => {
    ...
    return (
        ...
        <>
            ...
            {/* Desktop View */}
            <Container className='d-lg-flex flex-row flex-wrap d-none justify-content-center gap-0'>
            ...
            {/* Mobile View */}
            <Container className='p-0 d-sm-flex flex-column d-lg-none' style={{}}>
                <Carousel className=''
...
export default DiningGoaSlider